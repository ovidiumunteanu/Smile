...
export async function getMatches(params) {
    ...
    if(filter_religious != -1 && filter_religious != undefined){
        query.where("religious", "==", filter_religious);
    }
    if(filter_occupation != -1 && filter_occupation != undefined){
        query.where("occupation", "==", filter_occupation);
    }
