...
class KingdomStack extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            activeSlide: 0,
    ...
    render() {
        return (
            <Stack.Navigator screenOptions={{
                ...
                <Stack.Screen name="AllSupplierScreen" component={KingdomHomeScreen} options={{
                    headerShown: true
...
export default connect(mapStateToProps, mapDispatchToProps)(KingdomStack);