...
import AddPostScreen from "../screens/main/social/AddPostScreen";
        ...
        return (
            <Stack.Navigator screenOptions={{
                ...
                <Stack.Screen name="SocialHomeScreen" component={SocialHomeScreen} options={{
                    headerShown: true,
                    // headerLeft: (props) => <HeaderBackButton tintColor="black" labelVisible={false} style={{ marginLeft: 10 }} onPress={() => navigation.navigate("Start")} />
                }}/>
                <Stack.Screen name="AddPostScreen" component={AddPostScreen} options={{
                    headerShown: true,
                    headerLeft: (props) => <HeaderBackButton tintColor="white" labelVisible={false} style={{ marginLeft: 10 }} onPress={() => this.props.navigation.navigate("SocialHomeScreen")} />,
                    
                    headerTitle : () => (
                        <Text style={{fontSize: 20, color: 'white'}}>Agregar publicación</Text>
